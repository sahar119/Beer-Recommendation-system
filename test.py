...
@app.route("/recommend")
def view_method():
        dropdown_list = list_beers
        return render_template('scratch.html', dropdown_list=dropdown_list)
...
def predict():
        ...
        for i in  my_beer:
            ...
            #data.append(item)
            data.append(item)
        return render_template('scratch.html',user_input=user_input,data=data,dropdown_list=dropdown_list)



@app.route("/About Beer")
def about_beer():
        dropdown_list = list_beers
        return render_template('about.html', dropdown_list=dropdown_list)
...
def process():
    ...
    graph.set(ylabel=None)
    plt.savefig('static/style/graph.png')
    return render_template('about.html', dropdown_list=dropdown_list,url='/static/style/graph.png')
